...
builder.RootComponents.Add<DesktopDashboard>("#app");
...
var frontend = Environment.GetEnvironmentVariable("FRONTEND_DOTNET") ?? "6";
var backend = Environment.GetEnvironmentVariable("BACKEND_DOTNET") ?? "8";
